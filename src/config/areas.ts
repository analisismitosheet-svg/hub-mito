...
export const APPS: AppDef[] = [
  ...
  {
    id: 'rrhh-nomina-activa',
    areaId: 'rrhh',
    title: 'Nómina Activa',
    description: 'Empleados en nómina activa.',
    icon: Users,
    kind: 'internal',
    target: '/rrhh/empleados/nomina-activa',
    color: '#059669',
    permiso: 'rrhh.empleados.view',
  },
  {
    id: 'rrhh-planes-activos',
    areaId: 'rrhh',
    title: 'Planes Activos',
    description: 'Empleados con planes activos.',
    icon: ClipboardList,
    kind: 'internal',
    target: '/rrhh/empleados/planes-activos',
    color: '#0284c7',
    permiso: 'rrhh.empleados.view',
  },
  {
    ...
    areaId: 'rrhh',
    title: 'Bajas Mito',
    description: 'Empleados dados de baja por Mito.',
    icon: UserX,
    kind: 'internal',
    target: '/rrhh/empleados/bajas-mito',
    color: '#dc2626',
    permiso: 'rrhh.empleados.view',
  },
  {
    id: 'rrhh-bajas-planes',
    areaId: 'rrhh',
    title: 'Bajas Planes',
    description: 'Empleados dados de baja por Planes.',
    icon: UserMinus,
    kind: 'internal',
    target: '/rrhh/empleados/bajas-planes',
    color: '#be185d',
    permiso: 'rrhh.empleados.view',
  },
  {
